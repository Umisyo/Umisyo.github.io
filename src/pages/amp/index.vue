<template lang="pug">
  div.top
    img.top__icon(src="https://res.cloudinary.com/umisyo/image/upload/f_auto/v1568269864/Portfolio/icon_zmntgo.webp" width="100" height="100" alt="icon")
    h1.top__name Souta Kusunoki
    div.top__social
      a.top__social-link(href="http://github.com/Umisyo")
        img(src="https://res.cloudinary.com/umisyo/image/upload/f_auto/v1568269864/Portfolio/github-icon_xq1ml1.webp" width="40" height="40" alt="Github")
      a.top__social-link-instagram(href="http://instagram.com/ihcamonoihS")
        img(src="https://res.cloudinary.com/umisyo/image/upload/v1568269864/Portfolio/instagram-icon_pj3wv5.webp" width="40" height="40" alt="Instagram")
